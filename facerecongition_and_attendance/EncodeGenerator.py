...
for filename in os.listdir(folder_path):
    ...
    with Image.open(image_path) as img:
        ...
        new_image_path = os.path.join('Resized Images', filename.replace(".jpg", "").replace(".jpeg", "").replace(".png", "") + ".png")
        img.save(new_image_path, "PNG")

print("Resized Complete")

#Importing student images
folderPath = 'Resized Images' #path for the resized images
...
#         #     encode = face_recognition.face_encodings(img, known_face_locations=face_locations)[0]
#         # else:
